...
class jethexaControlNode:
    def __init__(self, node_name):
        ...
        # absolute rotatio. When RPY=0, 0, 0, the pan-tilt will face to the front
        ...
        self.cmd_vel_sub = rospy.Subscriber("~cmd_vel", geometry_msgs.msg.Twist, self.controller.cmd_vel)
        self.cmd_vel_sub_ = rospy.Subscriber("cmd_vel", geometry_msgs.msg.Twist, self.controller.cmd_vel)
        ...
        if odom_enable:
            ...
            # publish data to python2 and publish tf transformation
